...
Problem Description:
The Collatz sequence is an iterative sequence defined on the positive
integers by:
...
What is the length of the longest chain which has a starting number
under 1000?

Challenge: Same question, but for any starting number under 1,000,000
 (you may need to implement a cleverer-than-naive algorithm)

Note: There's still room for further optimization. Current solution
does not cache every collatz computation it performs. There's is a
superior recursive solution.
